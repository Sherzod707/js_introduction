...
console.log(`"every" funksiyasidan foydalanib, barcha elementlar indeks qiymatlaridan katta ekanligini tekshirish:
    massiv: ${array}, funksiya: elmGreaterIndex,  
    natija: ${every(array, elmGreaterIndex)} - true`);
